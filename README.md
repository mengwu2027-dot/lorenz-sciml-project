...
* `src/`: Contains the source code for data generation, models, and training scripts.
    * `models/`: Definitions for the MLP, PINN, and Neural ODE architectures.
    * `lorenz_solver.py`: Implements the RK45 numerical solver for the Lorenz system equations.
    * `generate_data.py`: Script to generate and save the ground truth trajectory using the solver.
